...
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**BibSentry**](https://github.com/lartpang/BibSentry)                                       | ![stars](https://img.shields.io/github/stars/lartpang/BibSentry)                    | BibSentry is a browser-based tool for checking and correcting `.bib` files. It parses entries locally, searches selected academic sources, shows what changed, and exports a reviewed BibTeX file. |
